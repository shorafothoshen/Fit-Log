      ...
      <div className="flex flex-col gap-8 lg:flex-row lg:gap-12">
        ...
        <div className="flex flex-col gap-5 lg:w-1/2">
          ...
          <div className="flex flex-wrap gap-3 pt-2">
            <button className="flex items-center gap-2 rounded-md bg-[#ccff00] px-4 py-2.5 text-xs font-bold uppercase text-black transition hover:brightness-110 sm:text-sm">
              <Calendar size={16} />
              Add to today's plan
            </button>
            <button className="flex items-center gap-2 rounded-md border border-[#24262a] px-4 py-2.5 text-xs font-bold uppercase text-white transition hover:bg-[#191c1e] sm:text-sm">
              <Bookmark size={16} />
              Save for later
            </button>
          </div>
